...
discussions, Discord) and also when an individual is officially representing
the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainer at **`lopop05905@proton.me`**. All complaints
...
1. **Correction** — Private, written warning, clarity around the nature of
...
3. **Temporary ban** — A temporary ban from any sort of interaction or
   public communication for a specified period.
